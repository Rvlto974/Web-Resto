        ...
        <div class="footer-grid" style="text-align: center;">
            <div class="footer-col" style="text-align: center;">
                ...
                <div class="footer-social" role="list" aria-label="Reseaux sociaux">
                    ...
                    <a href="https://x.com/viteetgourmand" target="_blank" rel="noopener noreferrer" class="social-icon" aria-label="X (Twitter) - ouvre dans un nouvel onglet" role="listitem"><i class="fa-brands fa-x-twitter" aria-hidden="true"></i></a>
