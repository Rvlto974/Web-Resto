<div class="container py-5">
    ...
    <div class="card shadow mb-4">
        <div class="card-body">
            ...
            <p>
                ...
                <strong>Capital social :</strong> 50 000 EUR<br>
                <strong>Telephone :</strong> 05 56 78 90 12<br>
                <strong>Email :</strong> contact@viteetgourmand.fr<br>
                <strong>Directeur de la publication :</strong> Jean-Pierre Martin
            </p>
        </div>
    </div>
    ...
    <div class="card shadow mb-4">
        <div class="card-body">
            ...
            <p>
                ...
                <strong>Site web :</strong> https://fly.io
            </p>
        </div>
    </div>
    ...
    <div class="card shadow mb-4">
        <div class="card-body">
            ...
            <p>
                Pour exercer ces droits ou pour toute question relative a vos donnees personnelles, vous pouvez
                nous contacter a l'adresse : <a href="mailto:rgpd@viteetgourmand.fr">rgpd@viteetgourmand.fr</a>
            </p>
            <p>
                Pour plus d'informations, consultez notre <a href="/contact/confidentialite">Politique de Confidentialite</a>.
            </p>
        </div>
    </div>
    ...
    <div class="card shadow mb-4">
        <div class="card-body">
            ...
            <p>
                Aucun cookie de tracking ou publicitaire n'est utilise sur ce site.
            </p>
        </div>
    </div>
    ...
    <div class="card shadow">
        <div class="card-body">
            ...
            <p>
                ...
                <strong>Technologies utilisees :</strong> PHP 8.2, MySQL 8, MongoDB 7, Bootstrap 5
            </p>
        </div>
    </div>
</div>
