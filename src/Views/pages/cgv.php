<div class="container py-5">
    ...
    <div class="card shadow mb-4">
        <div class="card-body">
            ...
            <p>
                ...
                et particuliers, ci-apres denommes "le Client".
            </p>
            <p>
    ...
    <div class="card shadow mb-4">
        <div class="card-body">
            ...
            <p>
                ...
                Toute commande doit etre confirmee par ecrit (email ou formulaire en ligne).
            </p>
            <h3 class="h5">2.2 Delai de commande</h3>
            <p>
                Un delai minimum de commande est requis pour chaque menu. Ce delai est indique sur la fiche
                de chaque menu et varie generalement de 3 a 7 jours ouvrables.
            </p>
            <h3 class="h5">2.3 Modification et annulation</h3>
            <p>
                Toute modification ou annulation doit etre notifiee au moins 48 heures avant la date de livraison.
                Passe ce delai, la commande sera due en totalite.
            </p>
        </div>
    </div>
    ...
    <div class="card shadow mb-4">
        <div class="card-body">
            ...
            <p>
                ...
                pour le nombre minimum de personnes indique.
            </p>
            <h3 class="h5">3.2 Personnes supplementaires</h3>
            <p>
                Un supplement par personne supplementaire est facture au-dela du nombre minimum.
                Une reduction de 10% est appliquee a partir de 5 personnes supplementaires.
            </p>
            <h3 class="h5">3.3 Frais de livraison</h3>
            <p>
                La livraison est gratuite dans Bordeaux intra-muros (codes postaux 33000, 33100, 33200, 33300, 33800).
                Pour les autres destinations, des frais de livraison de 5EUR + 0,59EUR/km sont appliques.
            </p>
        </div>
    </div>
    ...
    <div class="card shadow mb-4">
        <div class="card-body">
            ...
            <ul>
                <li>Especes</li>
                <li>Cheque (a l'ordre de Vite & Gourmand)</li>
                <li>Carte bancaire</li>
            </ul>
            <p>
                Pour les commandes superieures a 500EUR, un acompte de 30% peut etre demande a la commande.
            </p>
        </div>
    </div>
    ...
    <div class="card shadow mb-4">
        <div class="card-body">
            ...
            <p>
                ...
                L'heure de livraison est convenue lors de la commande.
            </p>
            <h3 class="h5">5.2 Materiel</h3>
            <p>
                Le materiel de service (plats, couverts, etc.) est prete gracieusement.
                Il doit etre retourne propre dans un delai de 10 jours suivant la livraison.
                En cas de non-retour ou de deterioration, des frais de remplacement seront factures.
            </p>
        </div>
    </div>
    ...
    <div class="card shadow mb-4">
        <div class="card-body">
            ...
            <p>
                Le Traiteur decline toute responsabilite en cas de non-respect des conditions de conservation.
            </p>
        </div>
    </div>
